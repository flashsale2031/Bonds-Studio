...
export default function ContactEarthGlobe({ contacts }: { contacts: ContactForEarth[] }) {
  ...
  return <section className="contact-earth-module border border-[#17231e]/10 bg-[#f9f5ec] overflow-hidden">
    <div className="contact-earth-header border-b border-[#17231e]/10 bg-[#1a2820] p-5 text-white">
      ...
      <form className="contact-earth-command-menu mt-5 grid gap-3 border border-white/10 bg-black/10 p-3 md:grid-cols-[minmax(220px,1fr)_180px_auto] md:items-end" onSubmit={submitEarthCommand} aria-label="Earth location and time command">
